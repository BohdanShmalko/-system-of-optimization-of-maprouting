...
describe('WebhooksController', () => {
    ...
    let webhookController: WebhookController = new WebhookController(
      new WebhookService(
    ...
    describe('WebhookController methods', () => {
      it('getWebhooks', async () => {
        ...
        const newWebhook1 = await webhookController.createNewWebhook(clientReq, newDto1);
        ...
        const newWebhook2 = await webhookController.createNewWebhook(clientReq, newDto2);
      ...
      it('createNewWebhook', async () => {
        ...
        const newWebhook: any = await webhookController.createNewWebhook(clientReq, newDto);
