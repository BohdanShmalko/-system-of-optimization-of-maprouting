...
describe('SuperAdminsApiService', () => {
    ...
    let superAdminsService: SuperAdminsApiService = new SuperAdminsApiService(
    ...
    describe('superAdminsService methods', () => {
      ...
      it('deleteClient', async () => {
        ...
        const newClient: any = await superAdminsService.createNewClient(adminReq, dto);
      ...
      it('updateClient', async () => {
        ...
        const newClient: any = await superAdminsService.createNewClient(adminReq, newDto);
