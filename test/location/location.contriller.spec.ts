...
import { CoreService, CreateUserHistoryDto, GetLocationDto, GetUserHistorysDto } from '@common';
...
describe('LocationController', () => {
    ...
    describe('locationController methods', () => {
      it('fixUserLocation', async () => {  
        ...
        const data = await locationController.fixUserLocation(clientReq, newDto);
        expect(data).toEqual({
      ...
      it('getUserLocation', async () => {
        ...
        newDto.time = 111111111;
        newDto.userId = 'uniqueUserId';
        const newLocation = await locationController.fixUserLocation(clientReq, newDto);
